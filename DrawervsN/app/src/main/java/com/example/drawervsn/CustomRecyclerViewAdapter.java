...
public class CustomRecyclerViewAdapter extends RecyclerView.Adapter<CountryViewHolder> {private List<Country> countries;
    ...
    public void onBindViewHolder(CountryViewHolder holder, int position) {
        ...
        holder.flagView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.countryNameView.setText( "hack name country");
                Toast.makeText(v.getContext(), "Helllllo", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public int getDrawableResIdByName(String resName)  {
        ...
        Log.i("Long", "Res Name: "+ resName+"==> Res ID = "+ resID);
        return resID;
    }
